...
<template>
    ...
    >
        ...
        <template v-else-if="name === 'brain'">
            <path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96.44 2.5 2.5 0 0 1-2.96-3.08 3 3 0 0 1-.34-5.58 2.5 2.5 0 0 1 1.32-4.24 2.5 2.5 0 0 1 4.44-1.04A2.5 2.5 0 0 1 9.5 2z" />
            <path d="M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96.44 2.5 2.5 0 0 0 2.96-3.08 3 3 0 0 0 .34-5.58 2.5 2.5 0 0 0-1.32-4.24 2.5 2.5 0 0 0-4.44-1.04A2.5 2.5 0 0 0 14.5 2z" />
        </template>

        <!-- Sparkle -->
        <template v-else-if="name === 'sparkle'">
            <path d="M12 3l1.66 5.34L19 10l-5.34 1.66L12 17l-1.66-5.34L5 10l5.34-1.66L12 3z" />
        </template>
        ...
        <!-- Radio (for level selection) -->
        <template v-else-if="name === 'radio-on'">
            <circle cx="12" cy="12" r="10" />
            <circle cx="12" cy="12" r="6" fill="currentColor" />
        </template>

        <template v-else-if="name === 'radio-off'">
            <circle cx="12" cy="12" r="10" />
        </template>
        ...
        <!-- Corner up right -->
        <template v-else-if="name === 'corner-up-right'">
